...
|---|---|---|
| `fig1_mechanism_overview` | Three connected aspects: learn representations/extractors; jointly learn denoising order, dependencies, and the transformer; share/specialize transformer computations | Proposed program for controllable multimodal generation; component labels, vectors, and module activity are illustrative |
