...
The **USD 23,999 cloud-services allocation** supports approximately **5,000 H100-80GB GPU-hours**, budgeted at USD 4.30 per GPU-hour, plus USD 2,499 for storage and other cloud charges. This planning rate is consistent with [posted H100 instance prices][computepricing]. One GPU-hour denotes one GPU used for one hour.
...
|---|---|---|
| Months 1–3 | Curate the interaction subset; obtain fixed representations and one task-trained alternative; build conditional denoisers and the image interface. | Working baseline, component definitions, and measured runtime. Select the interaction family and confirm the run budget. |
...
**Total requested: USD 149,999 for 12 months.** The budget supports 0.5 months of PI salary, 12 months of graduate research assistant support, associated fringe benefits and tuition remission, and cloud computing and storage.

| Budget category | Amount (USD) |
|---|---:|
| PI salary: Xiang Cheng, 0.5 months | 7,944 |
| Graduate research assistant stipend: 12 months | 44,213 |
| PI fringe benefits: 28.83% of PI salary | 2,290 |
| Graduate research assistant fringe benefits: 11.45% of stipend | 5,062 |
| Graduate tuition remission | 15,134 |
| Cloud computing and storage | 23,999 |
| **Total direct costs** | **98,642** |
| Indirect costs: 61.5% of modified total direct costs | 51,357 |
| **Total requested** | **149,999** |

**Budget basis.** The institutional workbook supplies the salary, fringe, stipend, tuition, and indirect-cost rates; amounts are rounded to whole dollars. PI salary uses a nine-month basis of USD 143,000. The modified total direct cost base is USD 83,508, including cloud services and excluding tuition remission. Applying the 61.5% indirect-cost rate gives USD 51,357. The total includes indirect costs and is within the Focused Research Award limit of USD 150,000. Cloud services fund the model development, controlled generation, and evaluation described in Section 6.
...
[computepricing]: https://lambda.ai/pricing
