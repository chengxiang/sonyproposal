...
**Figure 1. Learning a representation, transformer, and denoising procedure together.** The requested scene combines clothing attributes, a giver–receiver relationship, and an independent activity. The three research parts learn how to represent and jointly realize these requirements. Participants and relations illustrate possible information in the vectors; the actual division is learned and can be more complex. The diagram describes the proposed method, not an already demonstrated semantic assignment to modules.
