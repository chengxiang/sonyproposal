...
| Sparse score dependencies and feature-space composition ([Local Mechanisms][local]). | Learn component divisions and refine their dependence structure together with the transformer and generation schedules. Component denoising losses connect the learned order to the information the model can use. |
